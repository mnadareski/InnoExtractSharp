...
namespace InnoExtractSharp.Util
{
    ...
    /// </summary>
    public class LittleEndian<T> : Endianness<T>
    {
        /// <returns>true if we are running on a little-endian machine.</returns>
        ...
        private T DecodeStep(ref T value, byte[] buffer, int index)
        {
            ...
            if (value is byte)
            {
                ...
                newValue = (byte)(newValue | (bufferItem << (index * 8)));
            ...
            if (value is sbyte)
            {
                ...
                newValue = (sbyte)(newValue | (bufferItem << (index * 8)));
                return (T)Convert.ChangeType(newValue, typeof(T));
            }
            ...
            if (value is ushort)
            {
                ...
                newValue = (ushort)(newValue | (bufferItem << (index * 8)));
                return (T)Convert.ChangeType(newValue, typeof(T));
            }
            if (value is short)
            {
                ...
                newValue = (short)(newValue | (bufferItem << (index * 8)));
                return (T)Convert.ChangeType(newValue, typeof(T));
            }
            ...
            if (value is uint)
            {
                ...
                newValue = (uint)(newValue | (bufferItem << (index * 8)));
                return (T)Convert.ChangeType(newValue, typeof(T));
            }
            if (value is int)
            {
                ...
                newValue = (int)(newValue | (bufferItem << (index * 8)));
                return (T)Convert.ChangeType(newValue, typeof(T));
            }
            ...
            if (value is ulong)
            {
                ...
                newValue = (ulong)(newValue | (bufferItem << (index * 8)));
                return (T)Convert.ChangeType(newValue, typeof(T));
            }
            if (value is long)
            {
                ...
                newValue = (long)(newValue | (bufferItem << (index * 8)));
                return (T)Convert.ChangeType(newValue, typeof(T));
            }
        ...
        private byte EncodeStep(T value, int index)
        {
            ...
            {
                byte newValue = (value as byte?).Value;
                return (byte)((newValue >> (index * 8)) & 0xff);
            }
            if (value is sbyte)
            {
                sbyte newValue = (value as sbyte?).Value;
